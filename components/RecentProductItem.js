...
const handleAddToCartFinal = product => {

  if(product.type == "simple")
  handleAddToCart(product);
  else
  props.props.navigation.push("ProductDetail",{"ProductId":product.id})
...
return (
  <SafeAreaView>
      <TouchableOpacity onPress={()=>props.props.navigation.push("ProductDetail",{"ProductId":props.item.id})} ><View style={{height:props.height,width:props.width,backgroundColor:props.backgroundColor,marginEnd:props.marginEnd,borderRadius:props.borderRadius,borderWidth:props.borderWidth,borderColor:props.borderColor,marginTop:props.marginTop}}>
          ...
          {props.item!=undefined && props.item.type=='simple' && <View style={{justifyContent:"flex-start",alignItems:"flex-start",flexDirection:"row",marginHorizontal:3,marginVertical:3}}>
            <Text style={{color:"black", fontFamily:FONT.RobotoBold,textAlign:"left"}}>{props.item.price} DH</Text><Text style={{color:"black",fontFamily:FONT.RobotoLight,textDecorationLine:"line-through",fontSize:14,textAlign:"left",marginStart:3}} > {props.item.regular_price} DH</Text>{/*:<Text style={{color:"black",fontFamily:FONT.RobotoLight}}> 25dh/ea</Text>*/}
          </View>}
  ...
  />
          ...
          <TouchableOpacity onPress={()=>{handleAddToCartFinal(props.item)}} style={{position:"absolute",left:0,top:props.height/2-35}} ><View style={{height:30,width:65,borderRadius:10,justifyContent:"center",alignItems:"center",backgroundColor:Colors.greenBtnColor,flexDirection:"row",marginHorizontal:3,marginVertical:3}}>
