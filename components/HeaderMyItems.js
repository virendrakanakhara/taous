...
const renderProductItem = ({ item }) => (
  ...
  <View style={{height:100,width:"100%",flexDirection:"row"}}>
    ...
    <View style={{flex:3,justifyContent:"center"}}><Text style={{fontFamily:FONT.RobotoRegular,marginStart:10,fontSize:16,marginEnd:10}} numberOfLines={3}>{item.name}</Text></View>
  </View>
  </TouchableOpacity>
);
...
const renderCategoryItem = ({ item }) => (
  ...
  <View style={{height:35,width:"100%"}}>
    ...
    <View style={{flex:1,justifyContent:"center"}}><Text style={{fontFamily:FONT.RobotoRegular,marginStart:10,fontSize:16}} numberOfLines={3}>{item.name.replace("&amp;","&")}</Text></View>
  </View>
  </TouchableOpacity>
);
  ...
  <SafeAreaView>
            ...
            <View style={{width:"100%",flexDirection:"row",height:50}}>
                    <View style={{flex:1,height:"100%",justifyContent:"center",alignItems:"flex-start",marginStart:5}}>
                      ...
                      {props.showTitle && (<View style={{flex:1,height:"100%",justifyContent:"center"}}>
                        <Text style={{color:"white",fontSize:20,fontFamily:FONT.RobotoBold,textAlign:"center",marginStart:0}}>{props.title}</Text>
                      </View>)}
    ...
    <TextInput
      ...
      />
            ...
            <TouchableOpacity style={{flex:1}} onPress={()=> props.navigation.navigate("Myitems",{screen:'MyItemsStack'})} ><View style={{flex:1,alignItems:"center",justifyContent:"center",height:35,backgroundColor:Colors.greenBtnColor,borderBottomWidth:props.menu==1?5:0,borderBottomColor:Colors.drawerHeaderBackground}}><Text style={{color:"white",fontSize:14,fontFamily:props.menu==1?FONT.RobotoBold:FONT.RobotoRegular}}>{t('header_reorder_lbl')}</Text></View></TouchableOpacity>
            <TouchableOpacity style={{flex:1}} onPress={()=> props.navigation.navigate("Myitems",{screen:'MyListsStack'})}><View style={{flex:1,height:35,alignItems:"center",justifyContent:"center",backgroundColor:Colors.greenBtnColor,borderBottomWidth:props.menu==2?5:0,borderBottomColor:Colors.drawerHeaderBackground}}><Text style={{color:"white",fontSize:14,fontFamily:props.menu==2?FONT.RobotoBold:FONT.RobotoRegular}}>{t('header_lists_lbl')}</Text></View></TouchableOpacity>
            ...
            {showSuggestionList && <View style={{flex:1,marginHorizontal:20,width:"90%",backgroundColor:"white",borderBottomColor:"gray",borderLeftColor:"gray",borderTopColor:"white",borderRightColor:"gray",borderWidth:1,position:"absolute",left:0,top:"60%"}}>
              <View style={{height:530,width:"100%"}}>
                <View style={{height:35,borderBottomColor:Colors.commonbg,borderBottomWidth:1}}><Text style={{fontFamily:FONT.RobotoSemiBold,padding:5}}>CATEGORIES</Text></View>
                ...
                <View style={{height:35,borderBottomColor:Colors.commonbg,borderBottomWidth:1}}><Text style={{fontFamily:FONT.RobotoSemiBold,padding:5}}>PRODUCTS</Text></View>
