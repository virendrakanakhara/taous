...
return (
  <SafeAreaView>
      <TouchableOpacity onPress={()=>{props.props.navigation.push("ProductDetail")}}><View style={{height:props.height,width:props.width,backgroundColor:props.backgroundColor,marginEnd:props.marginEnd,borderRadius:props.borderRadius,borderWidth:props.borderWidth,borderColor:props.borderColor,marginTop:props.marginTop}}>
          ...
          <View style={{height:25,borderRadius:5,justifyContent:"center",alignItems:"center",backgroundColor:Colors.drawerHeaderBackground,flexDirection:"row",marginHorizontal:3,marginVertical:3}}>
          ...
          <View style={{height:25,borderRadius:5,justifyContent:"center",alignItems:"center",backgroundColor:Colors.greenBtnColor,flexDirection:"row",marginHorizontal:3,marginVertical:3}}>
